          ...
          <TableHead>
            <TableRow>
              <TableCell align="center" colSpan={2}>
                ...
                Optimal networks for tuition fee transfers—your preferences?
                </Typography>
              </TableCell>
            </TableRow>
          </TableHead>
              ...
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"OPTIMISMlogo"}
                    src={`${process.env.PUBLIC_URL}/${"OPTIMISMlogo"}.png`}
                    style={{ width: '500px', height: 'auto', marginTop: "10px" }}
                  />
                </Box>
              </TableCell>
            ...
            <TableRow>
              ...
              <Divider orientation="vertical" flexItem />
                <Box>
                  ...
                  >
                    <a href="https://exech-chutinunp.vercel.app/">OPTIMISM</a>
                  </Button>
                </Box>
              </TableCell>
            </TableRow>
